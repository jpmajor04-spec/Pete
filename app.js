  ...
  body.innerHTML = `
    <div class="tourn-form">
      ...
      <div class="tourn-fee-row">
        ...
        <button class="tourn-fee-btn" data-fee="15">15 <svg width="13" height="13" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="8" fill="#c8a010" stroke="#8a6808" stroke-width="1.2"/><circle cx="9" cy="9" r="5.8" fill="#d4b828"/><path d="M9 5C10.7 5 12 6 12 7.5C12 8.5 11.3 9.2 10.2 9.5C11.4 9.8 12.2 10.6 12.2 11.8C12.2 13.3 10.9 14 9 14C7.1 14 5.8 13.3 5.8 11.8H7.2C7.2 12.4 7.9 12.8 9 12.8C10 12.8 10.7 12.4 10.7 11.7C10.7 11 10 10.6 9 10.6H8V9.4H9C9.9 9.4 10.5 9 10.5 8.3C10.5 7.6 9.8 7.2 9 7.2C8.1 7.2 7.5 7.6 7.5 8.2H6.2C6.2 6.8 7.4 5 9 5Z" fill="#8a6808"/></svg></button>
        <button class="tourn-fee-btn" data-fee="50">50 <svg width="13" height="13" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="8" fill="#c8a010" stroke="#8a6808" stroke-width="1.2"/><circle cx="9" cy="9" r="5.8" fill="#d4b828"/><path d="M9 5C10.7 5 12 6 12 7.5C12 8.5 11.3 9.2 10.2 9.5C11.4 9.8 12.2 10.6 12.2 11.8C12.2 13.3 10.9 14 9 14C7.1 14 5.8 13.3 5.8 11.8H7.2C7.2 12.4 7.9 12.8 9 12.8C10 12.8 10.7 12.4 10.7 11.7C10.7 11 10 10.6 9 10.6H8V9.4H9C9.9 9.4 10.5 9 10.5 8.3C10.5 7.6 9.8 7.2 9 7.2C8.1 7.2 7.5 7.6 7.5 8.2H6.2C6.2 6.8 7.4 5 9 5Z" fill="#8a6808"/></svg></button>
        <button class="tourn-fee-btn" data-fee="100">100 <svg width="13" height="13" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="8" fill="#c8a010" stroke="#8a6808" stroke-width="1.2"/><circle cx="9" cy="9" r="5.8" fill="#d4b828"/><path d="M9 5C10.7 5 12 6 12 7.5C12 8.5 11.3 9.2 10.2 9.5C11.4 9.8 12.2 10.6 12.2 11.8C12.2 13.3 10.9 14 9 14C7.1 14 5.8 13.3 5.8 11.8H7.2C7.2 12.4 7.9 12.8 9 12.8C10 12.8 10.7 12.4 10.7 11.7C10.7 11 10 10.6 9 10.6H8V9.4H9C9.9 9.4 10.5 9 10.5 8.3C10.5 7.6 9.8 7.2 9 7.2C8.1 7.2 7.5 7.6 7.5 8.2H6.2C6.2 6.8 7.4 5 9 5Z" fill="#8a6808"/></svg></button>
        <button class="tourn-fee-btn" data-fee="200">200 <svg width="13" height="13" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="8" fill="#c8a010" stroke="#8a6808" stroke-width="1.2"/><circle cx="9" cy="9" r="5.8" fill="#d4b828"/><path d="M9 5C10.7 5 12 6 12 7.5C12 8.5 11.3 9.2 10.2 9.5C11.4 9.8 12.2 10.6 12.2 11.8C12.2 13.3 10.9 14 9 14C7.1 14 5.8 13.3 5.8 11.8H7.2C7.2 12.4 7.9 12.8 9 12.8C10 12.8 10.7 12.4 10.7 11.7C10.7 11 10 10.6 9 10.6H8V9.4H9C9.9 9.4 10.5 9 10.5 8.3C10.5 7.6 9.8 7.2 9 7.2C8.1 7.2 7.5 7.6 7.5 8.2H6.2C6.2 6.8 7.4 5 9 5Z" fill="#8a6808"/></svg></button>
      </div>
